package com.example.jobsheetcrud.adapter;
...
import com.example.jobsheetcrud.R;
import com.example.jobsheetcrud.RoomCreateActivity;
import com.example.jobsheetcrud.data.AppDatabase;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v =
                LayoutInflater.from(parent.getContext()).inflate(R.layout.item_barang,
                        parent, false);
        // mengeset ukuran view, margin, padding, dan parameter layoulainnya
